...
#define BLE_MUHA_GAP_MIN_CONN_INTERVAL   MSEC_TO_UNITS(400, UNIT_1_25_MS)   //!< Minimum acceptable connection interval (0.4 seconds).
#define BLE_MUHA_GAP_MAX_CONN_INTERVAL   MSEC_TO_UNITS(650, UNIT_1_25_MS)   //!< Maximum acceptable connection interval (0.65 second).
