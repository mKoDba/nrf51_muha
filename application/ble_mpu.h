...
//    ble_srv_cccd_security_mode_t  mpu_data_char_attr_md;        //!< Initial security level for MPU data characteristics attribute
...
extern BLE_ECGS_custom_S m_mpu;
