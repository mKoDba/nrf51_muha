...
#define TWI_HW_MASTER_SD_VERSION                true
#define TWI_HW_MASTER_SHORTS_VERSION            false
#define TWI_HW_MASTER_SD_MODIFIED_VERSION       false

#if (TWI_HW_MASTER_SD_VERSION == true)
...
static bool twi_master_write(uint8_t *data, uint8_t data_length, bool issue_stop_condition) {
    // max loops to wait for EVENTS_TXDSENT event
...
#elif (TWI_HW_MASTER_SHORTS_VERSION == true)
...
#elif (TWI_HW_MASTER_SD_MODIFIED_VERSION == true)
/* Copyright (c) 2009 Nordic Semiconductor. All Rights Reserved.
 *
 * The information contained herein is property of Nordic Semiconductor ASA.
 * Terms and conditions of usage are described in detail in NORDIC
